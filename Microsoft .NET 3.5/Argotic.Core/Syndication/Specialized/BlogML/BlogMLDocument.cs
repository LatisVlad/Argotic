...
namespace Argotic.Syndication.Specialized
{
    ...
    public class BlogMLDocument : ISyndicationResource, IExtensibleSyndicationObject
    {
        ...
        public static BlogMLDocument Create(Uri source)
        {
            ...
            //------------------------------------------------------------
            return BlogMLDocument.Create(source, null);
        }
        #endregion
        ...
        public static BlogMLDocument Create(Uri source, SyndicationResourceLoadSettings settings)
        {
            ...
            //------------------------------------------------------------
            return BlogMLDocument.Create(source, null, null, settings);
        }
        #endregion
        ...
        public static BlogMLDocument Create(Uri source, ICredentials credentials, IWebProxy proxy)
        {
            ...
            //	Create instance using supplied parameters and default settings
            //------------------------------------------------------------
            return BlogMLDocument.Create(source, credentials, proxy, null);
        }
        #endregion
                    ...
                    using (Stream stream = httpWebResponse.GetResponseStream())
                    {
                        ...
                        using (StreamReader streamReader = new StreamReader(stream, encoding))
                        {
                            ...
                            using (XmlReader reader = XmlReader.Create(streamReader, readerSettings))
                            {
                                ...
                                {
                                    navigator   = SyndicationEncodingUtility.CreateSafeNavigator(source, credentials, proxy, null);
                                }
                                else
                                {
                                    navigator   = SyndicationEncodingUtility.CreateSafeNavigator(source, credentials, proxy, settings.CharacterEncoding);
                                }
                                ...
                                //------------------------------------------------------------
                                document.OnDocumentLoaded(new SyndicationResourceLoadedEventArgs(navigator, source, credentials, proxy, userToken));
                            }
                        }
                    }
