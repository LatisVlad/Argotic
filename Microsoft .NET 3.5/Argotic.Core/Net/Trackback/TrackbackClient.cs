...
namespace Argotic.Net
{
    ...
    public class TrackbackClient
    {
        ...
        private static void AsyncSendCallback(IAsyncResult result)
        {
            ...
            if (result.IsCompleted)
            {
                ...
                if (client != null)
                {
                    ...
                    //------------------------------------------------------------
                    client.OnMessageSent(new TrackbackMessageSentEventArgs(host, message, response, credentials, proxy, userToken));
        ...
        public TrackbackResponse Send(TrackbackMessage message)
        {
            ...
            //------------------------------------------------------------
            WebRequest webRequest   = TrackbackClient.CreateWebRequest(this.Host, this.UserAgent, message, this.UseDefaultCredentials, this.Credentials, this.Proxy);
        ...
        public void SendAsync(TrackbackMessage message, Object userToken)
        {
            ...
            //------------------------------------------------------------
            asyncHttpWebRequest = TrackbackClient.CreateWebRequest(this.Host, this.UserAgent, message, this.UseDefaultCredentials, this.Credentials, this.Proxy);

            //------------------------------------------------------------
            //	Get the async response to the web request
            //------------------------------------------------------------
            object[] state      = new object[7] { asyncHttpWebRequest, this, this.Host, message, this.Credentials, this.Proxy, userToken };
        ...
        //	PRIVATE METHODS
        //============================================================
        #region CreateWebRequest(Uri host, string userAgent, TrackbackMessage message, bool useDefaultCredentials, ICredentials credentials, IWebProxy proxy)
        /// <summary>
        ...
        ///     A <see cref="ICredentials"/> object that represents the authentication credentials provided by this client when making Trackback pings. This parameter can be <b>null</b>.
        /// </param>
        /// <param name="proxy">
        ///     A <see cref="IWebProxy"/> object that represents the web proxy utilized by this client to proxy Trackback pings. This parameter can be <b>null</b>.
        /// </param>
        /// <exception cref="ArgumentNullException">The <paramref name="host"/> is a null reference (Nothing in Visual Basic).</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="userAgent"/> is a null reference (Nothing in Visual Basic).</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="userAgent"/> is an empty string.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="message"/> is a null reference (Nothing in Visual Basic).</exception>
        private static WebRequest CreateWebRequest(Uri host, string userAgent, TrackbackMessage message, bool useDefaultCredentials, ICredentials credentials, IWebProxy proxy)
        {
            //------------------------------------------------------------
            //	Local members
            //------------------------------------------------------------
