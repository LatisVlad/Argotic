...
namespace Argotic.Configuration
{
    ...
    public sealed class XmlRpcClientNetworkElement : ConfigurationElement
    {
        ...
        /// </summary>
        private readonly ConfigurationProperty configurationSectionHostProperty                 = new ConfigurationProperty("host", typeof(System.Uri), null, new UriTypeConverter(), null, ConfigurationPropertyOptions.None);
        /// <summary>
        /// Private member to hold the client default credentials configuration property for the element.
        /// </summary>
        private readonly ConfigurationProperty configurationElementDefaultCredentialsProperty   = new ConfigurationProperty("defaultCredentials", typeof(System.Boolean), false, new BooleanConverter(), null, ConfigurationPropertyOptions.None);
        /// <summary>
        /// Private member to hold the client user name configuration property for the element.
        /// </summary>
        private readonly ConfigurationProperty configurationElementUserNameProperty             = new ConfigurationProperty("userName", typeof(System.String), String.Empty, new StringConverter(), null, ConfigurationPropertyOptions.None);
        /// <summary>
        /// Private member to hold the client password configuration property for the element.
        /// </summary>
        private readonly ConfigurationProperty configurationElementPasswordProperty             = new ConfigurationProperty("password", typeof(System.String), String.Empty, new StringConverter(), null, ConfigurationPropertyOptions.None);
        /// <summary>
        /// Private member to hold the client domain configuration property for the element.
        /// </summary>
        private readonly ConfigurationProperty configurationElementDomainProperty               = new ConfigurationProperty("domain", typeof(System.String), String.Empty, new StringConverter(), null, ConfigurationPropertyOptions.None);
        /// <summary>
        /// Private member to hold a collection of configuration element properties for the element.
        /// </summary>
        private ConfigurationPropertyCollection configurationElementProperties                  = new ConfigurationPropertyCollection();
        #endregion
