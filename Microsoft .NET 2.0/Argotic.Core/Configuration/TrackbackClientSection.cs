...
namespace Argotic.Configuration
{
    ...
    public sealed class TrackbackClientSection : ConfigurationSection
    {
        ...
        /// </summary>
        private readonly ConfigurationProperty configurationSectionNetworkProperty      = new ConfigurationProperty("network", typeof(TrackbackClientNetworkElement), null, ConfigurationPropertyOptions.None);
        /// <summary>
